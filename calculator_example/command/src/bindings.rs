...
pub mod docs {
    ...
    pub mod calculator {
        ...
        pub mod calculate {
            ...
            pub fn eval_exprassion(op: Op, x: u32, y: u32) -> u32 {
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "docs:calculator/calculate@0.1.0")]
                    extern "C" {
                        #[link_name = "eval-exprassion"]
...
A\x02\x01B\x04\x01m\x02\x03add\x03mul\x04\0\x02op\x03\0\0\x01@\x03\x02op\x01\x01\
xy\x01yy\0y\x04\0\x0feval-exprassion\x01\x02\x03\x01\x1fdocs:calculator/calculat\
e@0.1.0\x05\0\x04\x01\x19docs:calculator/app@0.1.0\x04\0\x0b\x09\x01\0\x03app\x03\
